  ...
  const offNotif = () => {
    ...
    return(
        ...
        <div id="parking" className="  h-screen w-full flex flex-col items-center justify-center gap-10 px-2 sm:px-20 pt-20 pb-5 -top-20 bg-blue-400">
          <div className="bg-white h-full w-full flex flex-col items-center justify-center gap-5 rounded-xl px-5 sm:px-20">
            ...
            <div className="flex w-full justify-center gap-5 items-center sm:flex flex-col sm:flex-row sm:px-5">
              <div className="flex w-full gap-5 sm:justify-end justify-center">
                <ParkingSlot
                slot={1}
                status={status1}
                img={carimg1}

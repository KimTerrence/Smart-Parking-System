  ...
  const handleSubmit = async (e) => {
    ...
    return(
        <div className="w-full h-screen  fixed inset-0 bg-gray-900 bg-opacity-50 flex  justify-center items-center p-2 sm:p-0 z-50">
            <div className=" bg-white rounded-lg shadow-lg w-full sm:w-1/2  h-1/2 sm:h-40 sm:p-10 flex items-center flex-col justify-center"> 
            <p className="text-2xl font-bold text-center"></p>
                <div className="flex flex-col items-center justify-between w-full h-full">
                   <form className="flex gap-10 items-center justify-center h-full flex-col sm:flex-row " onSubmit={handleSubmit}>
